    ...
    <main class="form">
        <div class="card">
            <div class="card-header py-2">
                <h5 class="my-1">Create New Password</h5>
            </div>
            <div class="card-body text-center">
                <form class="form-resetpassword">
                    <div class="alert alert-danger js-error" role="alert" style="display: none;">
                    </div>
                    <div class="alert alert-success js-success" role="alert" style="display: none;">
                    </div>
                    ...
                    <div class="form-floating">
                        <input type="password" name="confirm_password" class="form-control" id="confirm_password" placeholder="Password" required="required">
                        <label for="confirm_password">Confirm Password</label>
                    </div>

                    <button class="btn btn-md btn-success btn-block w-100 py-2 my-2" type="submit">Reset Password</button>
                </form>
            </div>
        </div>
    </main>
